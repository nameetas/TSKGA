info = read.csv('../meta_16Sept.csv', row.names = 1)
...
# pdf('visiumBarplot_sampleAF.pdf', width = 9, height = 12)
#   ggarrange(p1, p3, ncol = 1, nrow = 2)
# dev.off()


df1 = read.csv('scFreq.csv')
...
meta1 = read.csv('scInfoAnno.csv', row.names = 1)
...
pdf('fig1B_new21Oct1.pdf', width = 9, height = 20)
